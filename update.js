...
try {
  ...
  fs.readAsJSON(properties, function (error, cf) {
    if (error) {
      // Check if there is error in request
      ...
      session.input.readAsJSON(function (errJson, msg) {
        if (errJson) {
            ...
            .sign("compact", function (error, jwsObj) {
              if (error) {
                ...
                try {
                  ...
                  //   console.log(
                  //     "HERE IS HEADER IAT " +
                  //       JSON.stringify(jweHdr.getProtected("iat"))
                  //   );
                  ...
                  //       if (error) {
                  //         console.error(
                  //           "Generating Encrypted Data Failed:" + error
                  //         );
          ...
          console.log(
            "Info:: Outgoing-ReqHdr -> " + "Authorization:xxx;kid:" + kid
          );
        }
      });
    }
